            ...
            <div class="container-fluid dashboard-content">
                ...
                <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Pourcentage retard jours</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                                            ...
                                            <tbody>
                                            <?php 
                                                while ($row = mysqli_fetch_array($r_p_ret_jours)) {
                                            ?>
                                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                $q_sum = "
                                                        SELECT sum(Nb_ret) AS T_ret, ROUND(sum(P_ret), 2) AS T_p FROM t_pourcentage_retard WHERE (Dates=Date(now()) AND Code!='STC')";
