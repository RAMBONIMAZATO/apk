...
<head>
    ...
    <title>Pourcentage retard hebdomadaire</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Pourcentage retard hebdomadaire </h2>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Graphe retard hebdomadaire </h5>
                            </div>
                            <div class="card-body">
                ...
                <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Pourcentage retard hebdo</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                                            ...
                                            <tbody>
                                            <?php 
                                                while ($row = mysqli_fetch_array($r_p_ret_hebdo)) {
                                            ?>
                                                        <tr>
...
/*                	'excel', 'pdf', 'csv', 'print'*/
{
    ...
    <script>
        ...
        {
            {
                $.post("../config/graph/graph_ret_h.php",
                function (data)
                {
                    console.log(data);
                    var name = [];
