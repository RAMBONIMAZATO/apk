                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        ?>
                                                    <tr>
                                                        <td><a href="l_abs_motif.php"><?php echo $row["UserId"]; ?></a></td>
                                                        <td><a href="l_abs_motif.php"><?php echo $row["Name"]; ?></a></td>
                                                        <input type="hidden" name="show_id" value="<?php echo $row["DeptId"]; ?>">
                                                        <td><a href="l_abs_motif.php"><?php echo $row["Code"]; ?></a></td>
                                                        <input type="hidden" name="show_id" value="<?php echo $row["Effectif"]; ?>">
                                                        <td><a href="l_abs_motif.php"><?php echo $row["Dates"]; ?></a></td>
                                                    </tr>
                                        <?php
                                            }
                                        ?>
