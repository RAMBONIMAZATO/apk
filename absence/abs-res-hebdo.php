...
<head>
    ...
    <title>Pourcentage absence hebdomadaire</title>
    <!-- Bootstrap CSS -->
...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Résultat sur l'absence hebdomadaire </h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Département</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Absence hebdomadaire</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Résultat absence hebdomadaire</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Graphe d'absence hebdomadaire</h5>
                            </div>
                            <div class="card-body">
    ...
    <script src="../assets/vendor/datepicker/datepicker/tempusdominus-bootstrap-4.js"></script>
    <script src="../assets/vendor/datepicker/datepicker/moment.js"></script>
        ...
        $(document).ready(function(){
            ...
            function fetch_data(is_date_search, start_date='', end_date='')
            {
                var dataTable = $('#order_data').DataTable({
                    ...
                    "order" : [],
                    "ajax" : {
                        url:"../config/connection/res_abs_h.php",
                        type:"POST",
                        data:{
    ...
    <script>
        ...
        {
            {
                $.post("../config/graph/graph_abs_h.php",
                function (data)
                {
                    console.log(data);
                    var name = [];
